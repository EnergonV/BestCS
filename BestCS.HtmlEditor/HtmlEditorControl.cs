...
namespace BestCS.HtmlEditor
{
    ...
    public sealed partial class HtmlEditorControl : UserControl
    {
        ...
        private const string HTML_TITLE_EDIT = "Редактировать Html";
        private const string HTML_TITLE_VIEW = "Просмотр Html";
        private const string PASTE_TITLE_HTML = "Ввести Html";
        private const string PASTE_TITLE_TEXT = "Ввести Текст";
        private const string HTML_TITLE_OPENFILE = "Открыть Файл Html";
        private const string HTML_TITLE_SAVEFILE = "Сохранить Файл Html";
        private const string HTML_FILTER = "Файлы Html (*.html,*.htm)|*.html;*htm|Все файлы (*.*)|*.*";
        ...
        private readonly string[] formatCommands = new String[] {"Форматированный", "Заголовок 1", "Заголовок 2", "Заголовок 3", "Заголовок 4", "Заголовок 5", "Нормальный"};
        ...
        public string InnerText
        {
            ...
            set
            {
                ...
                {
                    throw new HtmlEditorException("Не удаётся установить внутренний текст для тела документа.", "SetInnerText", ex);
                }
        ...
        public string InnerHtml
        {
            ...
            set
            {
                ...
                {
                    throw new HtmlEditorException("Не удаётся установить внутренний Html для тела документа.", "SetInnerHtml", ex);
                }
            }
        ...
        public string BodyHtml
        {
            ...
            set
            {
                ...
                {
                    throw new HtmlEditorException("Не удаётся установить внешний Html для тела документа.", "SetBodyHtml", ex);
                }
            }
        ...
        public string SelectedText
        {
            ...
            set
            {
                ...
                {
                    throw new HtmlEditorException("Не удаётся установить внутренный текст для выборки.", "SetSelectedText", ex);
                }
            }
        ...
        public string SelectedHtml
        {
            ...
            set
            {
                ...
                {
                    throw new HtmlEditorException("Не удаётся установить внутренний Html для выборки.", "SetSelectedHtml", ex);
                }
            }
        ...
        public void LoadFromUrl(string url)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    throw new HtmlEditorException(string.Format("Не является документом Html: {0}", url), "LoadFromUrl");
                }    
            }
            ...
            {
                // cannot load so throw an exception
                throw new HtmlEditorException(string.Format("Не удаётся загрузить Url: {0}", url), "LoadFromUrl", ex);
            }
            catch (Exception ex)
            {
                // cannot load so throw an exception
                throw new HtmlEditorException(string.Format("Не удаётся загрузить документ: {0}", url), "LoadFromUrl", ex);
            }
            finally
            {
        ...
        public void LoadFromFile(string filename)
        {
            ...
            {
                throw new HtmlEditorException("Недействительное название файла.", "LoadFromFile");
            }
        ...
        private void FormatFontChange(int change)
        {
            ...
            {
                throw new HtmlEditorException("Значение может быть лишь в диапазоне [1,6].", "FontIncreaseDecrease");
            }
            else
            {
                // obtain the selected range object
        ...
        public void InsertLine()
        {
            ...
            {
                throw new HtmlEditorException("Неправильно выбрано место вставки строки.", "InsertLine");
            }
        ...
        public void InsertImagePrompt()
        {
            ...
            if (control != null)
            {
                ...
                {
                    throw new HtmlEditorException("Рисунок может быть вставлен только поверх предыдущего.", "InsertImage");
                }
            }
        ...
        public void InsertLinkPrompt()
        {
            ...
            {
                throw new HtmlEditorException("Следует выбрать текст, из которого будет установлена ссылка.", "InsertLink");
            }
        ...
        public void InsertFormatBlock(string command)
        {
            ...
            {
                throw new HtmlEditorException("Неправильно выбран формат блока.", "InsertFormatBlock");
            }
            else
            {
        ...
        public void FormatFontAttributes(HtmlFontProperty font)
        {
            ...
            else
            {
                ...
                throw new HtmlEditorException("Неправильно выбран текст или шрифт.", "FormatFont");
            }
        ...
        public void TableInsertRow()
        {
            ...
            if (table != null && row != null)
            {
                ...
                {
                    throw new HtmlEditorException("Не удаётся вставить новый ряд", "TableinsertRow", ex);
                }
            }
            else
            {
                throw new HtmlEditorException("Этот ряд не выделен в таблице на данный момент", "TableInsertRow");
            }
        ...
        public void TableDeleteRow()
        {
            ...
            if (table != null && row != null)
            {
                ...
                {
                    throw new HtmlEditorException("Не удаётся удалить выделенный ряд", "TableDeleteRow", ex);
                }
            }
            else
            {
                throw new HtmlEditorException("Этот ряд не выделен в таблице на данный момент", "TableDeleteRow");
            }
        ...
        private void ProcessTable(mshtmlTable table, HtmlTableProperty tableProperties)
        {
            try
            {
                ...
                if (tableCreated)
                {
                    ...
                    if (textRange != null)
                    {
                        ...
                        {
                            throw new HtmlEditorException("Неправильно выделен текст для вставки таблицы.", "ProcessTable", ex);
                        }
                    }
                    else
                    {
                        ...
                        if (controlRange != null)
                        {
                            ...
                            {
                                throw new HtmlEditorException("Не удаётся удалить все ранее выдененные элементы управления.", "ProcessTable", ex);
                            }
                        }
                        else
                        {
            ...
            catch (Exception ex)
            {
                ...
                throw new HtmlEditorException("Не удаётся изменить свойства таблицы Html.", "ProcessTable", ex);
            }
        ...
        private HtmlTableProperty GetTableProperties(mshtmlTable table)
        {
            ...
            if (table != null)
            {
                ...
                catch (Exception ex)
                {
                    ...
                    throw new HtmlEditorException("Не удаётся определить свойства таблицы Html.", "GetTableProperties", ex);
                }
            }
        ...
        private bool ExecuteCommandQuery(mshtmlTextRange range, string command)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new HtmlEditorException("Неизвестная Ошибка MSHTML.", command, ex);
            }
            ...
            try
            {
                ...
                switch(command)
                {
                    ...
                    case INTERNAL_FORMATTED_PRE:
                        ...
                        break;
                    default:
                        throw new HtmlEditorException("Выполняется неизвестная операция.", command);
                }
            }
            catch (HtmlEditorException ex)
            {
