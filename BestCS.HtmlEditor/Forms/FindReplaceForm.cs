...
namespace BestCS.HtmlEditor
{
    ...
    /// <summary>
    /// Form designed to control Найти и Заменить operations
    /// Найти и Заменить operations performed by the user control class
    ...
    internal partial class FindReplaceForm : Form
    {
        ...
        private void bReplace_Click(object sender, System.EventArgs e)
        {
            ...
            {
                MessageBox.Show("Все совпадения претерпели замену!", "Найти и Заменить");
            }
        ...
        private void bReplaceAll_Click(object sender, System.EventArgs e)
        {
            ...
            MessageBox.Show(string.Format("{0} случаев заменено", found), "Найти и Заменить");
        ...
        private void bFindNext_Click(object sender, System.EventArgs e)
        {
            ...
            {
                MessageBox.Show("Совпадений больше не найдено!", "Найти и Заменить");
            }
