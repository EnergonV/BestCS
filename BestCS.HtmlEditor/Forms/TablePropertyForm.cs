...
using HtmlTableProperty =BestCS.HtmlEditor.HtmlTableProperty;
using MeasurementOption =BestCS.HtmlEditor.MeasurementOption;
using HorizontalAlignOption =BestCS.HtmlEditor.HorizontalAlignOption;
using VerticalAlignOption =BestCS.HtmlEditor.VerticalAlignOption;
