namespace BestCS.HtmlEditor
{
    partial class FontAttributeForm
    {
        ...
        private void InitializeComponent()
        {
        	...
        	this.checkUnderline.Size = new System.Drawing.Size(120, 16);
        	this.checkUnderline.TabIndex = 3;
        	this.checkUnderline.Text = "Подчёркивание";
        	...
        	this.labelSize.Text = "Размер Шрифта";
        	// 
        	// checkStrikeout
        	// 
        	...
        	this.checkStrikeout.Text = "Зачёркивание";
        	...
        	this.checkSubscript.Size = new System.Drawing.Size(121, 16);
        	this.checkSubscript.TabIndex = 8;
        	this.checkSubscript.Text = "Нижний Индекс";
        	// 
        	// checkSuperscript
        	// 
        	this.checkSuperscript.Location = new System.Drawing.Point(160, 160);
        	this.checkSuperscript.Name = "checkSuperscript";
        	this.checkSuperscript.Size = new System.Drawing.Size(120, 16);
        	this.checkSuperscript.TabIndex = 9;
        	this.checkSuperscript.Text = "Верхний Индекс";
        	// 
        	// listFontName
        	// 
        	...
        	this.labelName.Text = "Название Шрифта";
        	// 
        	// labelSample
        	// 
        	...
        	this.labelSample.Text = "Пример AaZa";
