...
using System.IO;
using BestCS.Compression.SevenZip.Sdk.Compression.LZ;
using BestCS.Compression.SevenZip.Sdk.Compression.RangeCoder;

namespace BestCS.Compression.SevenZip.Sdk.Compression.Lzma
{
    /// <summary>
