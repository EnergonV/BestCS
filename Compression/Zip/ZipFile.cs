...
using BestCS.Compression.Encryption;
#endif

using BestCS.Compression.Core;
using BestCS.Compression.Checksums;
using BestCS.Compression.Zip.Compression.Streams;
using BestCS.Compression.Zip.Compression;

namespace BestCS.Compression.Zip 
{
	...
	public class ZipFile : IEnumerable, IDisposable
	{
		...
		/// </exception>
		/// <exception cref="BestCS.Compression.Zip.ZipException">
