...
// the BestCS.NET Neural Net Library, part of the BestCS.NET Framework. The
// BestCS.NET Framework is also available under the LGPL.
//

namespace BestCS.Neuro.Learning
{
    using System;
    using System.Threading;
    using System.Threading.Tasks;
    using BestCS.Neuro;
    using BestCS.Neuro.Learning;
    ...
    /// <summary>
    ///   Compatibility shim to make BestCS.NET work on previous
    ///   version of the framework. This is just a wrapper around
    ///   BestCS.Neuro.Learning.ResilientBackpropagationLearning.
    /// </summary>
    /// 
    public class ParallelResilientBackpropagationLearning : BestCS.Neuro.Learning.ResilientBackpropagationLearning
    {
        /// <summary>
        ///   Initializes a new instance of the <see cref="ParallelResilientBackpropagationLearning"/> class.
        /// </summary>
        /// 
        public ParallelResilientBackpropagationLearning(BestCS.Neuro.ActivationNetwork network)
            : base(network) { }
