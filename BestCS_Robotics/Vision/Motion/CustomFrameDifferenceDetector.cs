...
namespace  BestCS.Vision.Motion
{
    using System;
    ...
    public class CustomFrameDifferenceDetector : IMotionDetector
    {
        ...
        public unsafe void ProcessFrame( UnmanagedImage videoFrame )
        {
            lock ( sync )
            {
                ...
                if ( backgroundFrame == null )
                {
                    ...
                    BestCS.Vision.Tools.ConvertToGrayscale( videoFrame, backgroundFrame );
                ...
                BestCS.Vision.Tools.ConvertToGrayscale( videoFrame, motionFrame );
        ...
        public void SetBackgroundFrame( UnmanagedImage backgroundFrame )
        {
            ...
            lock ( sync )
            {
                ...
                // convert source frame to grayscale
                BestCS.Vision.Tools.ConvertToGrayscale( backgroundFrame, this.backgroundFrame );
