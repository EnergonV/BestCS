// BestCS Surveyor Robotics Library
// BestCS.NET framework
// http://www.BestCSnet.com/framework/
//
// Copyright © BestCS.NET, 2005-2011
// contacts@BestCSnet.com
//

namespace BestCS.Robotics.Surveyor
{
    using System;
    ...
    /// </remarks>
    /// 
    public class SRV1Camera :  BestCS.Video.IVideoSource
    {
        ...
        /// </remarks>
        /// 
        public event  BestCS.Video.NewFrameEventHandler NewFrame;
        ...
        /// 
        public event  BestCS.Video.VideoSourceErrorEventHandler VideoSourceError;
        ...
        /// </remarks>
        /// 
        public event  BestCS.Video.PlayingFinishedEventHandler PlayingFinished;
