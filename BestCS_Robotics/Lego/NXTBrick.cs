...
namespace BestCS.Robotics.Lego
{
    using System;
    using BestCS.Robotics.Lego.Internals;
    ...
    public partial class NXTBrick
    {
        ...
        /// </summary>
        /// 
        public event  BestCS.MessageTransferHandler MessageSent;

        /// <summary>
        /// The event is raised every time a command is read successfully.
        /// </summary>
        /// 
        public event  BestCS.MessageTransferHandler MessageRead;
