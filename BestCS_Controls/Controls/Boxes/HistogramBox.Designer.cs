namespace BestCS.Controls
{
    partial class HistogramBox
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.histogramView1 = new BestCS.Controls.HistogramView();
            this.SuspendLayout();
            // 
            // histogramView1
            // 
            ...
            this.histogramView1.Histogram = new BestCS.Statistics.Visualizations.Histogram();//((BestCS.Statistics.Visualizations.Histogram)(resources.GetObject("histogramView1.Histogram")));
