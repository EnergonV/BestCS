...
namespace BestCS.Controls
{
    ...
    /// <summary>
    ///   Type converter for <see cref="BestCS.DoubleRange"/>
    ///   and <see cref="BestCS.IntRange"/> objects.
    /// </summary>
    /// 
    public class RangeTypeConverter : TypeConverter
    {
        ...
        /// <summary>
        ///   Assign this converter to the BestCS types. This method
        ///   should be called before an BestCS range type can be
