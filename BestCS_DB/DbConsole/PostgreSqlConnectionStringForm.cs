...
namespace DbConsole
{
	public partial class PostgreSqlConnectionStringForm : MyConnectionStringForm
	{
        bool m_Ok = false;
        ...
        private void InitializeComponent()
        {
            ...
            this.label3.Text = "ИД Пользователя:";
            // 
            // label4
            // 
            ...
            this.tbServerName.Text = "127.0.0.1";
            ...
            this.label7.Text = "Подключение к базе данных PostgreSql";
            // 
            ...
            this.Name = "PostgreSqlConnectionStringForm";
        ...
        public PostgreSqlConnectionStringForm()
        {
            InitializeComponent();
            SetStrings();
        }

        ~PostgreSqlConnectionStringForm() { this.Dispose(); }
        ...
        private void SetStrings()
        {
          ConnectionSumString = String.Format(
             "Server={0};Port={1};User Id={2};Password={3};Database={4};",
                 tbServerName.Text, tbPort.Text, tbLogin.Text, tbPassword.Text, tbDB.Text);
