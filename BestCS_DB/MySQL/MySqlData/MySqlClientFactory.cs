...
namespace MySqlProvider
{
  ...
  public sealed class MySqlProviderFactory : DbProviderFactory, IServiceProvider
  {
    /// <summary>
    /// Gets an instance of the <see cref="MySqlProviderFactory"/>. 
    /// This can be used to retrieve strongly typed data objects. 
    /// </summary>
    public static MySqlProviderFactory Instance = new MySqlProviderFactory();
    ...
    private FieldInfo MySqlDbProviderServicesInstance
    {
      get
      {
        if (mySqlDbProviderServicesInstance == null)
        {
          ...
          fullName = String.Format("MySqlProvider.MySqlProviderServices, {0}", assemblyEf5Name);

          Type providerServicesType = Type.GetType(fullName, false);
          if (providerServicesType == null)
          {
            fullName = String.Format("MySqlProvider.MySqlProviderServices, {0}", assemblyName);
