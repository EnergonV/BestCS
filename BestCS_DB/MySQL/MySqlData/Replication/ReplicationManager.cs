...
namespace MySqlProvider.Replication
{
  /// <summary>
  ...
  internal static class ReplicationManager
  {
    ...
    internal static ReplicationServerGroup AddGroup(string name, string groupType, int retryTime)
    {
      if (string.IsNullOrEmpty(groupType))
        groupType = "MySqlProvider.Replication.ReplicationRoundRobinServerGroup";
    ...
    internal static void GetNewConnection(string groupName, bool master, MySqlConnection connection)
    {
      do
      {
        lock (thisLock)
        {
          ...
          if (server == null)
            throw new MySqlException(SqlConsoleProvider.Properties.Resources.Replication_NoAvailableServer);
