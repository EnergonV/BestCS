...
namespace MySqlProvider
{
  ...
  public class CustomInstaller : Installer
  {
    ...
    private static void AddProviderToMachineConfigInDir(string path)
    {
      ...
      newNode.SetAttribute("invariant", "MySqlProvider");
      ...
      string type = String.Format("MySqlProvider.MySqlProviderFactory, {0}", a.FullName.Replace("Installers", "Data"));
      ...
      foreach (XmlNode node in nodes[0].ChildNodes)
      {
        ...
        {
          if (attr.Name == "invariant" && attr.Value == "MySqlProvider")
          {
