...
#if !CF
using MySqlProvider.Replication;
#endif
...
namespace MySqlProvider
{
  ...
  public sealed partial class MySqlConnection : IDisposable
  {
    ...
    [Editor("MySqlProvider.Design.ConnectionStringTypeEditor,MySqlProvider.Design", typeof(UITypeEditor))]
    [Browsable(true)]
    [Category("Data")]
    [Description(
    ...
    protected override DbProviderFactory DbProviderFactory
    {
      get
      {
        return MySqlProviderFactory.Instance;
      }
    }
