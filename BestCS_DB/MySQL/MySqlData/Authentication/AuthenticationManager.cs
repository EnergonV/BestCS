...
using System.Text;
using SqlConsoleProvider.Properties;


namespace MySqlProvider.Authentication
{
    internal class AuthenticationPluginManager
    {
      ...
      {
        plugins["mysql_native_password"] = new PluginInfo("MySqlProvider.Authentication.MySqlNativePasswordPlugin");
        plugins["sha256_password"] = new PluginInfo("MySqlProvider.Authentication.Sha256AuthenticationPlugin");
#if !CF && !RT
        plugins["authentication_windows_client"] = new PluginInfo("MySqlProvider.Authentication.MySqlWindowsAuthenticationPlugin");
