...
namespace MySqlProvider
{
  ...
  public sealed class MySqlProviderPermissionAttribute : DBDataPermissionAttribute
  {
      // Methods
      public MySqlProviderPermissionAttribute(SecurityAction action) : base(action)
      {
      }
