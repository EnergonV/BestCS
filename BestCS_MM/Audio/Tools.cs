...
namespace BestCS.Audio
{
    ...
    public static class Tools
    {
        ...
        /// </summary>
        /// 
        public static double[] GetMagnitudeSpectrum(System.Numerics.Complex[] fft)
        {
            if (fft == null)
        ...
        /// </summary>
        /// 
        public static double[] GetPowerSpectrum(System.Numerics.Complex[] fft)
        {
            if (fft == null) 
                throw new ArgumentNullException("fft");
        ...
        /// </summary>
        /// 
        public static double[] GetPhaseSpectrum(System.Numerics.Complex[] fft)
        {
        ...
        /// </summary>
        /// 
        public static double[] GetPowerCepstrum(System.Numerics.Complex[] signal)
        {
            if (signal == null)
            ...
            System.Numerics.Complex[] logabs = new System.Numerics.Complex[signal.Length];
            for (int i = 0; i < logabs.Length; i++)
                logabs[i] = new System.Numerics.Complex(System.Math.Log(signal[i].Magnitude), 0);
