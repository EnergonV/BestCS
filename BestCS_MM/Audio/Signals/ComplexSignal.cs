...
namespace BestCS.Audio
{
    ...
    public class ComplexSignal : Signal
    {
        ...
        /// </summary>
        /// 
        public System.Numerics.Complex[] GetChannel(int channel)
        {
            System.Numerics.Complex[] array = new System.Numerics.Complex[Length];
            int channels = Channels;
            int length = Length;

            unsafe
            {
                fixed (System.Numerics.Complex* ptrArray = array)
                {
                    var src = (System.Numerics.Complex*)Data + channel;
                    var dst = ptrArray;
        ...
        /// </summary>
        /// 
        private void SetChannel(int channel, System.Numerics.Complex[] samples)
        {
            int channels = Channels;
            int length = Length;
            ...
            unsafe
            {
                fixed (System.Numerics.Complex* ptrArray = samples)
                {
                    var dst = (System.Numerics.Complex*)Data + channel;
                    var src = ptrArray;
        ...
        public void ForwardHilbertTransform()
        {
            if (status == ComplexSignalStatus.Normal)
            {
                ...
                {
                    System.Numerics.Complex[] channel = GetChannel(c);
        ...
        /// <returns>Returns an instance of complex signal.</returns>
        /// 
        public static ComplexSignal FromArray(System.Numerics.Complex[,] array, int sampleRate, ComplexSignalStatus status)
        {
            int samples = array.GetLength(0);
            int channels = array.GetLength(1);
            ...
            byte[] buffer = new byte[array.Length * Marshal.SizeOf(typeof(System.Numerics.Complex))];
