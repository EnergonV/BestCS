...
namespace  BestCS.Video.Kinect
{
    ...
    internal static class KinectNative
    {
        ...
        [DllImport( "freenect.dll", CallingConvention = CallingConvention.Cdecl )]
        public static extern int freenect_init( ref IntPtr context, IntPtr freenectUSBContext );

        [DllImport( "freenect.dll", EntryPoint = "freenect_process_events", CallingConvention = CallingConvention.Cdecl )]
        ...
        [DllImport( "freenect.dll", EntryPoint = "freenect_process_events_timeout", CallingConvention = CallingConvention.Cdecl )]
        ...
        [DllImport( "freenect.dll", EntryPoint = "freenect_start_video", CallingConvention = CallingConvention.Cdecl )]
        ...
        [DllImport( "freenect.dll", EntryPoint = "freenect_stop_video", CallingConvention = CallingConvention.Cdecl )]
        ...
        [DllImport( "freenect.dll", EntryPoint = "freenect_start_depth", CallingConvention = CallingConvention.Cdecl )]
        ...
        [DllImport( "freenect.dll", EntryPoint = "freenect_stop_depth", CallingConvention = CallingConvention.Cdecl )]
        ...
        // Gets a freenect.dll context to work with.
