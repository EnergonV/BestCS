...
namespace BestCS.Imaging
{
    ...
    public class SpeededUpRobustFeaturePoint : IFeaturePoint
    {
        ...
        /// <summary>
        ///   Converts the feature point to a <see cref="BestCS.IntPoint"/>.
        /// </summary>
        /// 
        public BestCS.IntPoint ToIntPoint()
        {
            return new BestCS.IntPoint((int)X, (int)Y);
        }

        /// <summary>
        ///   Converts this object into a <see cref="BestCS.IntPoint"/>.
        /// </summary>
        /// 
        /// <returns>
        ...
        /// <summary>
        ///   Performs an implicit conversion from <see cref="BestCS.Imaging.SpeededUpRobustFeaturePoint"/>
        ...
        /// </returns>
        /// 
        public static implicit operator BestCS.IntPoint(SpeededUpRobustFeaturePoint point)
        {
