...
namespace BestCS.Imaging
{
    ...
    public class FastRetinaKeypoint : IFeaturePoint<byte[]>, IFeaturePoint
    {
        ...
        /// <summary>
        ///   Performs an implicit conversion from <see cref="BestCS.Imaging.FastRetinaKeypoint"/>
        ...
        /// </returns>
        /// 
        public static implicit operator BestCS.IntPoint(FastRetinaKeypoint point)
        {
