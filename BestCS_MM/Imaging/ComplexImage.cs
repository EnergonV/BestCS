...
namespace BestCS.Imaging
{
    ...
    {
        // image complex data
        private System.Numerics.Complex[,] data;
        ...
        protected ComplexImage(int width, int height)
        {
            this.width = width;
            this.height = height;
            this.data = new System.Numerics.Complex[height, width];
        ...
        {
            // create new image
            Bitmap dstImage = BestCS.Imaging.Image.CreateGrayscaleImage(width, height);
