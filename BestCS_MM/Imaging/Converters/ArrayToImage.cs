...
namespace BestCS.Imaging.Converters
{
    using System;
        ...
        IConverter<Color[], UnmanagedImage>
    {
        ...
        {
            output = BestCS.Imaging.Image.CreateGrayscaleImage(Width, Height);
            ...
            unsafe
            {
                ...
                for (int y = 0; y < Height; y++)
                {
                    ...
                    {
                        *dst = (byte)BestCS.Math.Tools.Scale(Min, Max, 0, 255, input[src]);
                    }
                    dst += offset;
                }
            }
            ...
            unsafe
            {
                ...
                for (int y = 0; y < Height; y++)
                {
                    for (int x = 0; x < Width; x++, src++)
                    {
                        ...
                        {
                            *dst = (byte)BestCS.Math.Tools.Scale(Min, Max, 0, 255, input[src][c]);
                        }
                    }
                    dst += offset;
                }
