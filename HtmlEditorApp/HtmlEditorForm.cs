...
namespace Development.Controls
{
    public partial class HtmlEditorForm : Form
    {
        ...
        public HtmlEditorForm(string fileToLoad)
        {
            InitializeComponent();
            this.htmlEditorControl.LoadFromFile(fileToLoad);
        ...
        private void bStyle_Click(object sender, System.EventArgs e)
        {
            ...
            if (File.Exists(cssFile))
            {
                ...
                MessageBox.Show(this, cssFile, "CSS Линкован", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            else
            {
                MessageBox.Show(this, cssFile, "CSS не найден", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            }
            this.htmlEditorControl.Focus();
        }
        ...
        private void bScript_Click(object sender, System.EventArgs e)
        {
            ...
            if (File.Exists(scriptFile))
            {
                ...
                MessageBox.Show(this, scriptFile, "Исходный Сценарий Линкован", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            else
            {
                MessageBox.Show(this, scriptFile, "Исходный Сценарий не Найден", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            }
            this.htmlEditorControl.Focus();
        }
        ...
        private void bImage_Click(object sender, System.EventArgs e)
        {
            ...
            {
                dialog.Title = "Выберите Рисунок";
                dialog.Filter = "Файлы Рисунков(*.BMP;*.JPG;*.GIF)|*.BMP;*.JPG;*.GIF|Все файлы (*.*)|*.*";
        ...
        private void HtmlEditorForm_Load(object sender, System.EventArgs e)
        {
        ...
        {
            string href = Microsoft.VisualBasic.Interaction.InputBox("Введите Href для Навигации:", "Href", string.Empty, -1, -1);
            if (href != string.Empty) this.htmlEditorControl.LoadFromUrl(href);
        }

        private void htmlEditorControl_HtmlException(object sender, BestCS.HtmlEditor.HtmlExceptionEventArgs args)
        {
        ...
        private void bLoadFile_Click(object sender, System.EventArgs e)
        {
            ...
            using (OpenFileDialog dialog = new OpenFileDialog())
            {
                ...
                dialog.Filter = "Файлы Html (*.html,*.htm)|*.html;*htm|Все файлы (*.*)|*.*";
                dialog.FilterIndex = 1;
                dialog.RestoreDirectory = true;
                if (workingDirectory != String.Empty) dialog.InitialDirectory = workingDirectory; 
