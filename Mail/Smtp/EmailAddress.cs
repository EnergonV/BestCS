...
/*******************************************************************************/
	...
	/// EmailAddress to = new EmailAddress("support@BestCS.OpenSmtp.com");
	...
	public class EmailAddress
	{
		...
		/// <example>
		/// <code>EmailAddress a = new EmailAddress("support@BestCS.OpenSmtp.com");</code>
		/// </example>
		...
		/// <example>
		/// <code>EmailAddress a = new EmailAddress("support@BestCS.OpenSmtp.com", "John Smith");</code>
		/// </example>
		...
		/// <example>"support@BestCS.OpenSmtp.com"</example>
