...
using System.Text;
	...
	///		cc				= new EmailAddress("cc@BestCS.OpenSmtp.com", "CC Name");
	///
	///		msg 			= new MailMessage(from, to);
	///		msg.AddRecipient(cc, AddressType.Cc);
	///		msg.AddRecipient("bcc@BestCS.OpenSmtp.com", AddressType.Bcc);
	///
	...
	public class MailMessage
	{
		...
		/// <example>
		/// <code>
		/// 	EmailAddress from 	= new EmailAddress("support@BestCS.OpenSmtp.com", "Support");
		/// 	EmailAddress to 	= new EmailAddress("recipient@BestCS.OpenSmtp.com", "Joe Smith");
		...
		/// <code>
		/// 	MailMessage msg = new MailMessage("support@BestCS.OpenSmtp.com", "recipient@BestCS.OpenSmtp.com");
		///		EmailAddress cc = new EmailAddress("cc@BestCS.OpenSmtp.com");
		///		msg.AddRecipient(cc, AddressType.Cc);
		/// </code>
		/// </example>
		...
		/// <code>
		/// 	MailMessage msg = new MailMessage("support@BestCS.OpenSmtp.com", "recipient@BestCS.OpenSmtp.com");
		///		msg.AddRecipient("cc@BestCS.OpenSmtp.com", AddressType.Cc);
		/// </code>
		/// </example>
