namespace BestCS.OpenSmtp.Mail 
{

/******************************************************************************
	Copyright 2001-2005 Ian Stallings
	BestCS.OpenSmtp.Net is free software; you can redistribute it and/or modify
	it under the terms of the Lesser GNU General Public License as published by
	the Free Software Foundation; either version 2 of the License, or
	(at your option) any later version.

	BestCS.OpenSmtp.Net is distributed in the hope that it will be useful,
...
using System.Collections;
	...
	/// <example>
	/// <code>
	///		from = new EmailAddress("support@BestCS.OpenSmtp.com", "Support");
	///		to = new EmailAddress("recipient@BestCS.OpenSmtp.com", "Joe Smith");
	///
	///		msg = new MailMessage(from, to);
	///		msg.Subject = "Testing BestCS.OpenSmtp .Net SMTP component";
	...
	public class Smtp
	{
		...
		/// <code>
		/// 	Smtp smtp = new Smtp();
		/// 	smtp.Host = "mail.BestCS.OpenSmtp.com";
		/// 	smtp.Port = 25;
		/// </code>
		/// </example>
		public Smtp()
		...
		/// <example>
		/// <code>
		/// 	Smtp smtp = new Smtp("mail.BestCS.OpenSmtp.com", 25);
		/// </code>
		/// </example>
		...
		/// <example>
		/// <code>
		/// 	Smtp smtp = new Smtp("mail.BestCS.OpenSmtp.com", "login", "pwd");
		/// </code>
		/// </example>
		...
		/// <example>
		/// <code>
		/// 	Smtp smtp = new Smtp("mail.BestCS.OpenSmtp.com", "login", "pwd", 25);
		/// </code>
		/// </example>
		...
		/// <example>"mail.BestCS.OpenSmtp.com"</example>
		public string Host
		{
		...
		/// <code>
		/// 	Smtp smtp = new Smtp("mail.BestCS.OpenSmtp.com", 25);
		///		smtp.SendMail("support@BestCS.OpenSmtp.com", "recipient@BestCS.OpenSmtp.com", "Hi", "Hello Joe Smith");
		/// </code>
		/// </example>
		...
		/// <example>
		/// <code>
		///		MailMessage msg = new MailMessage("support@BestCS.OpenSmtp.com", "recipient@BestCS.OpenSmtp.com");
		///		msg.Subject = "Hi";
		///		msg.Body = "Hello Joe Smith."
		/// 	Smtp smtp = new Smtp();
		///		smtp.SendMail(msg, "mail.BestCS.OpenSmtp.com", 25);
		/// </code>
		/// </example>
