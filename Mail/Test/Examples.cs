...
using System.Text;
using BestCS.OpenPop.Common.Logging;
using BestCS.OpenPop.Mime;
using BestCS.OpenPop.Mime.Decode;
using BestCS.OpenPop.Mime.Header;
using BestCS.OpenPop.Pop3;

namespace BestCS.OpenPopExamples
{
	/// <summary>
	/// These are small examples problems for the
	/// <see cref="BestCS.OpenPop"/>.NET POP3 library
	/// </summary>
	public class Examples
	{
		...
		Encoding CustomFallbackDecoder(string characterSet)
		{
			...
			// You can also return null here, which would tell BestCS.OpenPop that
		...
		// TreeNodeBuilder class in BestCS.OpenPopTest
	}
}