...
using BestCS.Mail.Mime;
using BestCS.Mail.Mime.Header;
using BestCS.Mail.Pop3;
using BestCS.Mail.Pop3.Exceptions;
using BestCS.Mail.Common.Logging;
using Message = BestCS.Mail.Mime.Message;

namespace BestCS.Mail.TestApplication
{
	/// <summary>
	...
	public class TestForm : Form
	{
		...
		private TestForm()
		{
			...
			string file = Path.Combine(myDocs, "BestCS.OpenPopLogin.txt");
			if (File.Exists(file))
			{
		...
		private void InitializeComponent()
		{
			...
			this.useSslCheckBox.Size = new System.Drawing.Size(56, 17);
			this.useSslCheckBox.TabIndex = 4;
			this.useSslCheckBox.Text = "С SSL";
			...
			// 
			this.totalMessagesTextBox.Location = new System.Drawing.Point(619, 33);
			...
			// labelTotalMessages
			// 
			this.labelTotalMessages.Location = new System.Drawing.Point(619, 5);
			...
			// passwordTextBox
			// 
			this.passwordTextBox.Location = new System.Drawing.Point(321, 35);
			...
			// labelUsername
			// 
			this.labelUsername.Location = new System.Drawing.Point(253, 5);
			...
			// loginTextBox
			// 
			this.loginTextBox.Location = new System.Drawing.Point(342, 5);
			...
			this.connectAndRetrieveButton.Size = new System.Drawing.Size(107, 39);
			this.connectAndRetrieveButton.TabIndex = 5;
			this.connectAndRetrieveButton.Text = "Подключиться и Получить";
			this.connectAndRetrieveButton.Click += new System.EventHandler(this.ConnectAndRetrieveButtonClick);
			// 
			// labelServerPort
			// 
			this.labelServerPort.Location = new System.Drawing.Point(93, 39);
			this.labelServerPort.Name = "labelServerPort";
			this.labelServerPort.Size = new System.Drawing.Size(35, 23);
			this.labelServerPort.TabIndex = 3;
			this.labelServerPort.Text = "Порт";
			// 
			// portTextBox
			// 
			...
			this.labelServerAddress.Text = "Адрес Сервера POP";
			this.labelServerAddress.Click += new System.EventHandler(this.LabelServerAddressClick);
			// 
			// popServerTextBox
			// 
			...
			this.popServerTextBox.Size = new System.Drawing.Size(119, 20);
			...
			this.labelMessageNumber.Text = "Сообщения";
			// 
			// attachmentPanel
			// 
			...
			this.labelAttachments.Text = "Включения";
			// 
			// saveFile
			// 
			this.saveFile.Title = "Сохранить Включение";
			// 
			// TestForm
			// 
			...
			this.Text = "Тест Сборки BestCS.Mail ";
		...
		private void ListMessagesMessageSelected(object sender, TreeViewEventArgs e)
		{
			...
			if (listMessages.SelectedNode.Tag is MessagePart)
			{
				...
				else
				{
					...
					messageTextBox.Text = "<<BestCS.Mail>> Cannot show this part of the email. It is not text <<BestCS.Mail>>";
				}
			}
			else
			{
				...
				} else
				{
					...
					if (textVersions.Count >= 1)
						...
						messageTextBox.Text = "<<BestCS.Mail>> Cannot find a text version body in this message to show <<BestCS.Mail>>";
				}
			}
		...
		void LabelServerAddressClick(object sender, EventArgs e)
		{
