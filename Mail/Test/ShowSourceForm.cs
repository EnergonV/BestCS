...
namespace BestCS.Mail.TestApplication
{
	...
	public class ShowSourceForm : Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.Text = "Источник (С использованием кодировки US-ASCII)";
			this.Load += new System.EventHandler(this.ShowSourceFormLoad);
			this.mainPanel.ResumeLayout(false);
			this.ResumeLayout(false);

		}
		void ShowSourceFormLoad(object sender, System.EventArgs e)
		{
