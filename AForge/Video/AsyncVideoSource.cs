...
namespace  BestCS.Video
{
    ...
    public class AsyncVideoSource : IVideoSource
    {
        ...
        // Note: image cloning is taken from  BestCS.Imaging.Image.Clone() to avoid reference,
        ...
        private static Bitmap CloneImage( BitmapData sourceData )
        {
            ...
            BitmapData destinationData = destination.LockBits(
             ...
             BestCS.SystemTools.CopyUnmanagedMemory( destinationData.Scan0, sourceData.Scan0, height * sourceData.Stride );
