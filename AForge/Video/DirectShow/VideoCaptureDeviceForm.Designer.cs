namespace  BestCS.Video.DirectShow
{
    partial class VideoCaptureDeviceForm
    {
        ...
        {
        	System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(VideoCaptureDeviceForm));
        	...
        	this.groupBox1.Text = "Настройки устройства видеозахвата";
        	// 
        	// videoInputsCombo
        	// 
        	...
        	this.snapshotsLabel.Size = new System.Drawing.Size(114, 13);
        	this.snapshotsLabel.TabIndex = 15;
        	this.snapshotsLabel.Text = "Разрешение снимка:";
        	// 
        	...
        	this.label1.Text = "Видеоустройство:";
        	// 
        	// pictureBox
        	// 
        	...
        	this.Text = "Открыть локальное устройство видеозахвата";
