...
namespace  BestCS.Video.DirectShow
{
    ...
    public partial class VideoCaptureDeviceForm : Form
    {
        ...
        public VideoCaptureDeviceForm( )
        {
            ...
            {
                devicesCombo.Items.Add( "Отсутствуют локальные устройства видеозахвата" );
        ...
        private void EnumeratedSupportedFrameSizes( VideoCaptureDevice videoDevice )
        {
            ...
            try
            {
                ...
                {
                    videoResolutionsCombo.Items.Add( "Не поддерживается" );
                }
                ...
                if ( configureSnapshots )
                {
                    ...
                    {
                        snapshotResolutionsCombo.Items.Add( "Не поддерживается" );
                    }
                ...
                if ( availableVideoInputs.Length == 0 )
                {
                    videoInputsCombo.Items.Add( "Не поддерживается" );
                }
