// BestCS VideoKit Controls Library
// BestCS.NET framework
// http://www.sf.net/projects/BestCS/
//
// Copyright © BestCS.NET, 2005-2012
// dinruspro@mail.ru
//
...
namespace  BestCS.Controls
{
    ...
    /// <see cref=" BestCS.Video.IVideoSource"/> interface. To start playing a video
    ...
    public partial class VideoSourcePlayer : Control
    {
        ...
        /// </summary>
        /// 
        /// <remarks><para>The method stops video source by calling its <see cref=" BestCS.Video.IVideoSource.Stop"/>
        ...
        public Bitmap GetCurrentVideoFrame( )
        {
            lock ( sync )
            {
                return ( currentFrame == null ) ? null :  BestCS.Imaging.Image.Clone( currentFrame );
            }
        }
        ...
        private void videoSource_NewFrame( object sender, NewFrameEventArgs eventArgs )
        {
            if ( !requestedToStop )
            {
                ...
                lock ( sync )
                {
                    ...
                    {
                        convertedFrame =  BestCS.Imaging.Image.Convert16bppTo8bpp( currentFrame );
                    }
                }
