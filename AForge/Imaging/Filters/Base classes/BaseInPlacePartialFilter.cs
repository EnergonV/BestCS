    ...
    public abstract class BaseInPlacePartialFilter : IFilter, IInPlaceFilter, IInPlacePartialFilter, IFilterInformation
    {
        ...
        public Bitmap Apply( BitmapData imageData )
        {
            ...
            Bitmap dstImage = ( dstPixelFormat == PixelFormat.Format8bppIndexed ) ?
                 BestCS.Imaging.Image.CreateGrayscaleImage( width, height ) :
            ...
            // copy image
             BestCS.SystemTools.CopyUnmanagedMemory( dstData.Scan0, imageData.Scan0, imageData.Stride * height );
        ...
        public void Apply( UnmanagedImage sourceImage, UnmanagedImage destinationImage )
        {
            ...
            unsafe
            {
                ...
                {
                     BestCS.SystemTools.CopyUnmanagedMemory( dst, src, lineSize );
                    dst += dstStride;
                    src += srcStride;
                }
            }
