...
namespace  BestCS.Imaging.Filters
{
    ...
    {
        // texture generator
        private  BestCS.Imaging.Textures.ITextureGenerator textureGenerator;
        // generated texture
        ...
        /// </remarks>
        /// 
        public  BestCS.Imaging.Textures.ITextureGenerator TextureGenerator
        {
        ...
        /// 
        public Texturer(  BestCS.Imaging.Textures.ITextureGenerator generator ) : this( )
        {
        ...
        /// <param name="preserveLevel">Preserve level value (see <see cref="PreserveLevel"/> property).</param>
        /// 
        public Texturer(  BestCS.Imaging.Textures.ITextureGenerator generator, double filterLevel, double preserveLevel )
            : this( )
        {
            this.textureGenerator = generator;
            this.filterLevel = filterLevel;
