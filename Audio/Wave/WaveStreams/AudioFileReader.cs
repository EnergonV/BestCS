using System;
using  BestCS.Audio.Wave.SampleProviders;

namespace  BestCS.Audio.Wave
{
    /// <summary>
    /// AudioFileReader simplifies opening an audio file in  BestCS.Audio
    ...
    public class AudioFileReader : WaveStream, ISampleProvider
    {
        ...
        /// <summary>
        /// Creates the reader stream, supporting all filetypes in the core  BestCS.Audio library,
