...
namespace  BestCS.Audio.Wave
{
    ...
    public class AsioOut : IWavePlayer
    {
        ...
        /// n.b. Future  BestCS.Audio may modify this
        /// </summary>
        ...
        /// </summary>
        [Obsolete("this function will be removed in a future  BestCS.Audio as ASIO does not support setting the volume on the device")]
        public float Volume
        {
            get
            {
