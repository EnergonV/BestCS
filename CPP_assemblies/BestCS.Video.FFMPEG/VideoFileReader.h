// BestCS FFMPEG Library
// BestCS.NET framework
// http://www.aforgenet.com/framework/
//
// Copyright © BestCS.NET, 2009-2011
...
using namespace BestCS::Video;

namespace BestCS { namespace Video { namespace FFMPEG
{
	...
	/// to use this class successfully. <b>FFmpeg</b> binaries can be found in Externals folder provided with BestCS.NET
