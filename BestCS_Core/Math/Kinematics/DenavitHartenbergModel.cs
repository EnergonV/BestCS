...
namespace BestCS.Math.Kinematics
{
    using System;
    ...
    public class DenavitHartenbergModel : IEnumerable<DenavitHartenbergJoint>
    {
        ...
        // TODO: remove the NonSerialized tags in case BestCS.NET implements 
        // [Serializable] for those structs in the future (BestCS.NET Issue 349)
