...
namespace BestCS.Math
{
    ...
    public static partial class Matrix
    {
        ...
        {
            return BestCS.Math.Jagged.Diagonal(values);
        }
        ...
        {
            return BestCS.Math.Jagged.Diagonal(size, value);
        }
        ...
        public static double[,] Random(int size, bool symmetric, double minValue, double maxValue)
        {
            ...
            if (!symmetric)
            {
                for (int i = 0; i < size; i++)
                    for (int j = 0; j < size; j++)
                        matrix[i, j] = BestCS.Math.Tools.Random.NextDouble() * (maxValue - minValue) + minValue;
            }
            else
            {
                for (int i = 0; i < size; i++)
        ...
        {
            return BestCS.Math.Vector.Random(size, minValue, maxValue);
        }
        ...
        {
            return BestCS.Math.Vector.Create(n, values);
        }
        ...
        {
            return BestCS.Math.Vector.Create(n, value);
        ...
        {
            return BestCS.Math.Vector.Interval(a, b, (double)increment);
        }
        ...
        {
            return BestCS.Math.Vector.Interval(a, b, points);
        }
        #endregion
        ...
        {
            return BestCS.Math.Indices.Range(from, to);
        }
        ...
        {
            return BestCS.Math.Indices.Until(to);
        }
        ...
        {
            return BestCS.Math.Vector.Interval(from, to);
        }
        ...
        {
            return BestCS.Math.Vector.Interval(from, to, stepSize);
        }
        ...
        {
            return BestCS.Math.Vector.Interval(from, to, (float)stepSize);
        }
        ...
        {
            return BestCS.Math.Vector.Interval(range, steps);
        }
        ...
        {
            return BestCS.Math.Vector.Interval(from, to, steps);
        }
