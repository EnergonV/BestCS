...
namespace BestCS.Math
{
    ...
    ///   To use this class, import the <see cref="BestCS.Math"/> and use the
    ...
    ///   
    ///   <para>
    ///     Declaring and using matrices in the BestCS.NET Framework does
    ...
    ///     by BestCS.NET. This is because BestCS.NET is built to interoperate
    ...
    ///   
    ///   <para>
    ///     This is all you need to start using the BestCS.NET matrix library.</para>
    ///     
    ...
    ///     in BestCS.NET is simply using: </para>
    ///     
    /// <code>
    ///     double[,] matrix = 
    ///     {
    ...
    ///    classes or vectors to make BestCS.NET work, which is a plus if you
    ...
    /// </example>
    /// 
    /// <seealso cref="BestCS.Math.DefaultMatrixFormatProvider"/>
    /// <seealso cref="BestCS.Math.DefaultArrayFormatProvider"/>
    /// <seealso cref="BestCS.Math.OctaveMatrixFormatProvider"/>
    /// <seealso cref="BestCS.Math.OctaveArrayFormatProvider"/>
    /// <seealso cref="BestCS.Math.CSharpMatrixFormatProvider"/>
    /// <seealso cref="BestCS.Math.CSharpArrayFormatProvider"/>
    /// 
