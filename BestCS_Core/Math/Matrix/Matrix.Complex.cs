...
namespace BestCS.Math
{
    ...
    ///  BestCS.NET's <seealso cref="Complex"/> data type.
    /// </summary>
    /// 
    public static class ComplexMatrix
    {
        ...
        /// </summary>
        /// 
        public static System.Numerics.Complex[] Abs(this System.Numerics.Complex[] x)
        {
            if (x == null)
                throw new ArgumentNullException("x");

            System.Numerics.Complex[] r = new System.Numerics.Complex[x.Length];
            for (int i = 0; i < x.Length; i++)
                r[i] = new System.Numerics.Complex(x[i].Magnitude, 0);
            return r;
        }
        ...
        /// </summary>
        /// 
        public static System.Numerics.Complex Sum(this System.Numerics.Complex[] x)
        {
            if (x == null) throw new ArgumentNullException("x");

            System.Numerics.Complex r = System.Numerics.Complex.Zero;
            for (int i = 0; i < x.Length; i++)
                r += x[i];
            return r;
        }
        ...
        /// </summary>
        /// 
        public static System.Numerics.Complex[] Multiply(this System.Numerics.Complex[] a, System.Numerics.Complex[] b)
        {
            if (a == null) throw new ArgumentNullException("a");
            if (b == null) throw new ArgumentNullException("b");

            System.Numerics.Complex[] r = new System.Numerics.Complex[a.Length];
            for (int i = 0; i < a.Length; i++)
            {
                r[i] = System.Numerics.Complex.Multiply(a[i], b[i]);
            }
            return r;
        }
        ...
        /// </summary>
        /// 
        public static double[] Magnitude(this System.Numerics.Complex[] c)
        {
            if (c == null) 
        ...
        /// 
        public static double[] Re(this System.Numerics.Complex[] c)
        {
            if (c == null) throw new ArgumentNullException("c");
        ...
        public static double[] Im(this System.Numerics.Complex[] c)
        {
            if (c == null)
                throw new ArgumentNullException("c");
        ...
        public static double[,] ToArray(this System.Numerics.Complex[] c)
        {
            if (c == null)
                throw new ArgumentNullException("c");
        ...
        /// </returns>
        /// 
        public static System.Numerics.Complex[] ToComplex(this double[] real)
        {
            if (real == null)
                throw new ArgumentNullException("real");

            System.Numerics.Complex[] arr = new System.Numerics.Complex[real.Length];
            for (int i = 0; i < arr.Length; i++)
                arr[i] = new System.Numerics.Complex(real[i], 0);
        ...
        /// </summary>
        public static bool IsEqual(this System.Numerics.Complex[][] objA, System.Numerics.Complex[][] objB, double threshold)
        {
...
#endif
        public static double SquaredMagnitude(this System.Numerics.Complex value)
        {
