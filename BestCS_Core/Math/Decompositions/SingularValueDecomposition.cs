...
namespace BestCS.Math.Decompositions
{
    using System;
                ...
                fixed (Double* A = a)
                {
                    ...
                    for (int k = 0; k < mrc; k++)
                    {
                        if (k < nct)
                        {
                            ...
                            s[k] = 0;
                            for (int i = k; i < m; i++)
                                s[k] = BestCS.Math.Tools.Hypotenuse(s[k], a[i, k]);
                        ...
                        if (k < nrt)
                        {
                            ...
                            e[k] = 0;
                            for (int i = k + 1; i < n; i++)
                                e[k] = BestCS.Math.Tools.Hypotenuse(e[k], e[i]);
                            ...
                            case 1:
                                {
                                    ...
                                    for (int j = p - 2; j >= k; j--)
                                    {
                                        Double t = BestCS.Math.Tools.Hypotenuse(s[j], f);
                                        Double cs = s[j] / t;
                                        Double sn = f / t;
                                        s[j] = t;
                                        if (j != k)
                            ...
                            case 3:
                                {
                                    ...
                                    for (int j = k; j < p - 1; j++)
                                    {
                                        Double t = BestCS.Math.Tools.Hypotenuse(f, g);
                                        Double cs = f / t;
                                        Double sn = g / t;
                                        if (j != k) e[j - 1] = t;
                                        f = cs * s[j] + sn * e[j];
                                        ...
                                        t = BestCS.Math.Tools.Hypotenuse(f, g);
                                        cs = f / t;
                                        sn = g / t;
                                        s[j] = t;
                                        f = cs * e[j] + sn * s[j + 1];
