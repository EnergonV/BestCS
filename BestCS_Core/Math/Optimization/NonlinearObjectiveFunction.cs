...
namespace BestCS.Math.Optimization
{
    ...
    public class NonlinearObjectiveFunction : IObjectiveFunction
    {
        ...
        protected NonlinearObjectiveFunction()
        {
            ...
            readOnlyVariables = new BestCS.Collections.ReadOnlyDictionary<string, int>(variables);
            readOnlyIndices = new BestCS.Collections.ReadOnlyDictionary<int, string>(indices);
        }
