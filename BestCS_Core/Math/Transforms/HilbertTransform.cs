...
namespace BestCS.Math
{
    ...
    public static class HilbertTransform
    {
        ...
        /// </summary>
        /// 
        public static void FHT(System.Numerics.Complex[] data, FourierTransform.Direction direction)
        {
            int N = data.Length;
            ...
            if (direction == FourierTransform.Direction.Forward)
            {
                ...
                System.Numerics.Complex[] shift = (System.Numerics.Complex[])data.Clone();
                ...
                for (int i = (N / 2) + 1; i < N; i++)
                {
                    shift[i] = System.Numerics.Complex.Zero;
                }
                ...
                for (int i = 0; i < N; i++)
                    data[i] = new System.Numerics.Complex(data[i].Real, shift[i].Imaginary);
            }
            ...
            else // Backward operation
            {
                ...
                for (int i = 0; i < data.Length; i++)
                    data[i] = new System.Numerics.Complex(data[i].Real, 0.0);
            }
        }
