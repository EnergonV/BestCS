    ...
    public class KCurvature
    {
        ...
        public List<IntPoint> FindPeaks(List<IntPoint> contour)
        {
            ...
            for (int i = 0; i < contour.Count; i++)
            {
                ...
                int ai = BestCS.Math.Tools.Mod(i + K, contour.Count);
                int ci = BestCS.Math.Tools.Mod(i - K, contour.Count);
                ...
                //double angle = BestCS.Math.Geometry.GeometryTools.GetAngleBetweenVectors(b, a, c);
            ...
            for (int i = 0; i < map.Length; i++)
            {
                ...
                {
                    int index = BestCS.Math.Tools.Mod(i + j, map.Length);
