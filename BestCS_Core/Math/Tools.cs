...
namespace BestCS.Math
{
    ...
    public static class Tools
    {
        ...
        ///   internally by the BestCS.NET classes and methods.
        /// </summary>
        /// 
        ...
        public static double Angle(IntPoint previous, IntPoint next)
        {
            ...
            return BestCS.Math.Tools.Angle(dx, dy);
        }
        ...
        public static int Direction(IntPoint previous, IntPoint next)
        {
            ...
            double radians = BestCS.Math.Tools.Angle(dx, dy);
        ...
        {
            return BestCS.Math.Vector.Scale(x, from, to);
        }
        ...
        {
            return BestCS.Math.Vector.Scale(x, fromMin, fromMax, toMin, toMax);
        }
        ...
        {
            return BestCS.Math.Vector.Scale(x, toMin, toMax);
        }
