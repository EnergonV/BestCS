...
namespace BestCS.MachineLearning.DecisionTrees.Learning
{
    ...
    ///   alphabet through the use of a <see cref="BestCS.Statistics.Filters.Codification">codebook</see>.</para>
    /// 
    /// <para>
    ...
    public class ID3Learning
    {
            ...
            for (int i = 0; i < children.Length; i++)
            {
                ...
                if (children[i].IsLeaf)
                {
                    ...
                    if (!Rejection && !children[i].Output.HasValue)
                        children[i].Output = BestCS.Statistics.Tools.Mode(output);
                }
            }
            ...
            out int[][] partitions, out int[][] outputSubset)
        {
            ...
            for (int i = 0; i < partitions.Length; i++)
            {
                ...
                double e = BestCS.Statistics.Tools.Entropy(outputSubset[i], outputClasses);
