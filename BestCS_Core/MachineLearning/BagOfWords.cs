...
namespace BestCS.MachineLearning
{
    ...
    public class BagOfWords : IBagOfWords<string[]>
    {
        ...
        private void initialize(string[][] texts)
        {
            ...
            readOnlyStringToCode = new BestCS.Collections.ReadOnlyDictionary<string, int>(stringToCode);
            readOnlyCodeToString = new BestCS.Collections.ReadOnlyDictionary<int, string>(codeToString);
