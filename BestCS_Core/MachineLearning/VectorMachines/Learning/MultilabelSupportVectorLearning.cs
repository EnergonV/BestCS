...
namespace BestCS.MachineLearning.VectorMachines.Learning
{
    using System;
    using BestCS.Math;
    ...
    public class MultilabelSupportVectorLearning : ISupportVectorMachineLearning
    {
        ...
        /// </summary>
        /// 
        /// <param name="args">The <see cref="BestCS.MachineLearning.VectorMachines.Learning.SubproblemEventArgs"/> instance containing the event data.</param>
        /// 
