...
namespace BestCS.Statistics
{
    ...
    public static partial class Tools
    {
        ...
        ///   double[] means = BestCS.Statistics.Tools.Mean(matrix);
        ///   </code>
        /// </example>
        /// 
        ...
        ///   
        ///   // column means are equal to (4.5, -0.25, 7.0)
        ///   double[] colMeans = BestCS.Statistics.Tools.Mean(matrix, 0);
        ///     
        ///   // row means are equal to (2.0, 5.5)
        ///   double[] rowMeans = BestCS.Statistics.Tools.Mean(matrix, 1);
        ///   </code>
        /// </example>
        /// 
