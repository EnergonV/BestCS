...
namespace BestCS.Statistics
{
    using System;
    using System.Collections.Generic;
    using BestCS.Math;
    using BestCS.Math.Decompositions;
    using BestCS.Statistics.Kernels;
    using BestCS;
    ...
    public static partial class Tools
    {
        ...
        public static double[] Proportions(int[] positives, int[] negatives)
        {
            ...
            return BestCS.Statistics.Groups.Proportions(positives, negatives);
        }
        ...
        {
            // TODO: Mark as obsolete
            return BestCS.Statistics.Groups.Proportions(data, positiveColumn, negativeColumn);
        }
        ...
        {
            return BestCS.Statistics.Groups.Group(data, labelColumn, dataColumn);
        }
        ...
        {
            // TODO: Mark as obsolete
            return BestCS.Statistics.Groups.Expand(data, positives, negatives);
        }
        ...
        {
            // TODO: Mark as obsolete
            return BestCS.Statistics.Groups.Expand(data, labelColumn, positiveColumn, negativeColumn);
        }
        ...
        {
            // TODO: Mark as obsolete
            return BestCS.Statistics.Groups.Expand(labels);
        }
        ...
        {
            // TODO: Mark as obsolete
            return BestCS.Statistics.Groups.Expand(labels, negative, positive);
        }
        ...
        {
            // TODO: Mark as obsolete
            return BestCS.Statistics.Groups.Expand(labels, classes);
        }
        ...
        {
            // TODO: Mark as obsolete
            return BestCS.Statistics.Groups.Expand(labels, classes, negative, positive);
        }
        #endregion
        ...
        {
            // TODO: Mark as obsolete
            return BestCS.Math.Indices.Random(k, n);
        }
        ...
        {
            // TODO: Mark as obsolete
            return BestCS.Statistics.Groups.Random(size, groups);
        }
        ...
        {
            // TODO: Mark as obsolete
            return BestCS.Statistics.Groups.Random(size, proportion);
        }
        ...
        {
            // TODO: Mark as obsolete
            return BestCS.Statistics.Groups.Random(labels, classes, groups);
        }
        ...
        {
            double[,] A = BestCS.Math.Matrix.Random(size, true, minValue, maxValue);
