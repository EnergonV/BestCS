...
namespace BestCS.Statistics.Analysis
{
    using BestCS.Collections;
    using BestCS.Math;
    using BestCS.Statistics.Distributions.Univariate;
    using BestCS;
    using System;
    ...
    /// </example>
    /// 
    /// <seealso cref="BestCS.Statistics.Tools"/>
    ...
    public class DescriptiveAnalysis : IMultivariateAnalysis
    {
        ...
        public double[,] DeviationScores
        {
            get
            {
                if (this.dScores == null)
                    this.dScores = BestCS.Statistics.Tools.Center(Source, Means, inPlace: false);
                return this.dScores;
            }
        }
        ...
        public double[,] StandardScores
        {
            get
            {
                if (this.zScores == null)
                    this.zScores = BestCS.Statistics.Tools.Standardize(DeviationScores, StandardDeviations, inPlace: false);
                return this.zScores;
            }
        }
            ...
            get
            {
                if (covarianceMatrix == null)
                {
                    if (sourceMatrix != null)
                        covarianceMatrix = BestCS.Statistics.Tools.Covariance(sourceMatrix, Means);
                    else covarianceMatrix = BestCS.Statistics.Tools.Covariance(sourceArray, Means);
                }
        ...
        public double[,] CorrelationMatrix
        {
            get
            {
                ...
                {
                    if (sourceMatrix != null)
                        correlationMatrix = BestCS.Statistics.Tools.Correlation(sourceMatrix, Means, StandardDeviations);
                    else correlationMatrix = BestCS.Statistics.Tools.Correlation(sourceArray, Means, StandardDeviations);
                }
        ...
        public double[] Means
        {
            get
            {
                ...
                {
                    if (sourceMatrix != null)
                        means = BestCS.Statistics.Tools.Mean(sourceMatrix, Sums);
                    else means = BestCS.Statistics.Tools.Mean(sourceArray, Sums);
                }
                return means;
            }
        }
        ...
        public double[] StandardDeviations
        {
            get
            {
                ...
                {
                    if (sourceMatrix != null)
                        standardDeviations = BestCS.Statistics.Tools.StandardDeviation(sourceMatrix, Means);
                    else standardDeviations = BestCS.Statistics.Tools.StandardDeviation(sourceArray, Means);
                }
        ...
        public double[] StandardErrors
        {
            get
            {
                if (standardErrors == null)
                    standardErrors = BestCS.Statistics.Tools.StandardError(samples, StandardDeviations);
        ...
        public double[] Modes
        {
            get
            {
                ...
                {
                    if (sourceMatrix != null)
                        modes = BestCS.Statistics.Tools.Mode(sourceMatrix);
                    else modes = BestCS.Statistics.Tools.Mode(sourceArray);
                }
        ...
        public double[] Medians
        {
            get
            {
                ...
                {
                    if (sourceMatrix != null)
                        medians = BestCS.Statistics.Tools.Median(sourceMatrix);
                    else medians = BestCS.Statistics.Tools.Median(sourceArray);
                }
        ...
        public double[] Variances
        {
            get
            {
                ...
                {
                    if (sourceMatrix != null)
                        variances = BestCS.Statistics.Tools.Variance(sourceMatrix, Means);
                    else variances = BestCS.Statistics.Tools.Variance(sourceArray, Means);
                }
        ...
        public int[] Distinct
        {
            get
            {
                ...
                {
                    if (sourceMatrix != null)
                        distinct = BestCS.Statistics.Tools.DistinctCount(sourceMatrix);
                    else distinct = BestCS.Statistics.Tools.DistinctCount(sourceArray);
                }
        ...
        public DoubleRange[] Quartiles
        {
            get
            {
                ...
                {
                    if (sourceMatrix != null)
                        this.medians = BestCS.Statistics.Tools.Quartiles(sourceMatrix, out this.quartiles);
                    else this.medians = BestCS.Statistics.Tools.Quartiles(sourceArray, out this.quartiles);
                }
            ...
            get
            {
                if (innerFences == null)
                {
                    ...
                    for (int i = 0; i < innerFences.Length; i++)
                        innerFences[i] = BestCS.Statistics.Tools.InnerFence(Q[i]);
                }
            ...
            get
            {
                if (outerFences == null)
                {
                    ...
                    for (int i = 0; i < outerFences.Length; i++)
                        outerFences[i] = BestCS.Statistics.Tools.OuterFence(Q[i]);
                }
        ...
        public double[] Sums
        {
            get
            {
                ...
                {
                    if (sourceMatrix != null)
                        this.sums = BestCS.Math.Matrix.Sum(sourceMatrix);
                    else this.sums = BestCS.Math.Matrix.Sum(sourceArray);
                }
        ...
        public double[] Skewness
        {
            get
            {
                ...
                {
                    if (sourceMatrix != null)
                        this.skewness = BestCS.Statistics.Tools.Skewness(sourceMatrix);
                    else this.skewness = BestCS.Statistics.Tools.Skewness(sourceArray);
                }
        ...
        public double[] Kurtosis
        {
            get
            {
                ...
                {
                    if (sourceMatrix != null)
                        this.kurtosis = BestCS.Statistics.Tools.Kurtosis(sourceMatrix);
                    else this.kurtosis = BestCS.Statistics.Tools.Kurtosis(sourceArray);
                }
