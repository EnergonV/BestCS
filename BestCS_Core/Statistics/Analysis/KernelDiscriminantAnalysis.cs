...
namespace BestCS.Statistics.Analysis
{
    ...
    public class KernelDiscriminantAnalysis : LinearDiscriminantAnalysis
    {
        ...
        public override void Compute()
        {
            ...
            base.Means = BestCS.Statistics.Tools.Mean(K);
            base.StandardDeviations = BestCS.Statistics.Tools.StandardDeviation(K, Means);
            ...
            for (int c = 0; c < Classes.Count; c++)
            {
                ...
                double[] mean = BestCS.Statistics.Tools.Mean(Kc);


                // Construct the Kernel equivalent of the Within-Class Scatter matrix
                double[,] Swi = BestCS.Statistics.Tools.Scatter(Kc, mean, (double)count);
                ...
                base.ClassStandardDeviations[c] = BestCS.Statistics.Tools.StandardDeviation(Kc, mean);
            }
