...
namespace BestCS.Statistics.Analysis
{
    ...
    public class PartialLeastSquaresAnalysis : IMultivariateRegressionAnalysis, IProjectionAnalysis
    {
        ...
        public PartialLeastSquaresAnalysis(double[,] inputs, double[,] outputs, AnalysisMethod method, PartialLeastSquaresAlgorithm algorithm)
        {
            ...
            this.meanX = BestCS.Statistics.Tools.Mean(inputs);
            this.meanY = BestCS.Statistics.Tools.Mean(outputs);
            this.stdDevX = BestCS.Statistics.Tools.StandardDeviation(inputs, meanX);
            this.stdDevY = BestCS.Statistics.Tools.StandardDeviation(outputs, meanY);
