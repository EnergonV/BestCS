...
namespace BestCS.Statistics.Analysis
{
    ...
    public class LinearDiscriminantAnalysis : IDiscriminantAnalysis, IProjectionAnalysis
    {
        ...
        public virtual void Compute()
        {
            ...
            Means = BestCS.Statistics.Tools.Mean(source);
            StandardDeviations = BestCS.Statistics.Tools.StandardDeviation(source, totalMeans);
            ...
            for (int c = 0; c < Classes.Count; c++)
            {
                ...
                // Get the class mean
                double[] mean = BestCS.Statistics.Tools.Mean(subset);


                // Continue constructing the Within-Class Scatter Matrix
                double[,] Swi = BestCS.Statistics.Tools.Scatter(subset, mean, (double)count);
                ...
                this.classStdDevs[c] = BestCS.Statistics.Tools.StandardDeviation(subset, mean);
            }
