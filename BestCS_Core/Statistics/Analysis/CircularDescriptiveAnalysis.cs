            ...
            get
            {
                if (modes == null)
                {
                    if (sourceMatrix != null)
                        ...
                        modes = BestCS.Statistics.Tools.Mode(sourceArray);
                    else modes = new[] { BestCS.Statistics.Tools.Mode(sourceRow) };
                }
            ...
            get
            {
                if (distinct == null)
                {
                    if (sourceMatrix != null)
                        ...
                        distinct = BestCS.Statistics.Tools.DistinctCount(sourceArray);
                    else
                        distinct = new[] { BestCS.Statistics.Tools.DistinctCount(sourceRow) };
                }
            ...
            get
            {
                if (sums == null)
                {
                    if (sourceMatrix != null)
                        ...
                        this.sums = BestCS.Math.Matrix.Sum(sourceArray);
                    else this.sums = new[] { BestCS.Math.Matrix.Sum(sourceRow) };
                }
