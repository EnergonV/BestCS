...
namespace BestCS.Statistics.Analysis
{
    ...
    public class KernelPrincipalComponentAnalysis : PrincipalComponentAnalysis
    {
        ...
        private static void centerKernel(double[,] newK, double[,] K)
        {
            ...
            double[] rowMean1 = BestCS.Statistics.Tools.Mean(newK, 1);
            double[] rowMean2 = BestCS.Statistics.Tools.Mean(K, 1);
