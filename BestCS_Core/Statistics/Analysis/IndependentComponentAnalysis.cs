...
namespace BestCS.Statistics.Analysis
{
    ...
    using BestCS.Statistics.Analysis.ContrastFunctions;
    ...
    public class IndependentComponentAnalysis : IMultivariateAnalysis
    {
            ...
            IndependentComponentAlgorithm algorithm)
        {
            ...
            this.columnMeans = BestCS.Statistics.Tools.Mean(sourceMatrix);
            this.columnStdDev = BestCS.Statistics.Tools.StandardDeviation(sourceMatrix, columnMeans);
        }
        ...
        public void Compute(int components)
        {
            ...
            double[,] whiten = BestCS.Statistics.Tools.Whitening(matrix, out whiteningMatrix);
            ...
            for (int i = 0; i < components; i++)
            {
                ...
                do // until convergence
                {
                    ...
                    else
                    {
                        ...
                        // Compute E{ g'(w*x) }
                        double mean = BestCS.Statistics.Tools.Mean(dgwx);
