...
namespace BestCS.Statistics.Models.Markov
{
    ...
    internal static class MarkovHelperMethods
    {
        ...
        internal static double[][] convertNoCheck(Array array, int dimension)
        {
            ...
            if (univariate != null) return BestCS.Math.Matrix.Split(univariate, dimension);
        ...
        internal static double[][] checkAndConvert(Array observations, int dimension)
        {
            ...
            // Test if the observations are multivariate
            {
                ...
                if (univariate != null)
                {
                    ...
                    return BestCS.Math.Matrix.Split(univariate, dimension);
                }
            }

            {
                ...
                if (univariate != null)
                {
                    ...
                    return BestCS.Math.Matrix.Split(univariate, dimension).ToDouble();
                }
            }
