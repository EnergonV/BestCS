...
namespace BestCS.Statistics.Models.Markov.Learning
{
    using System;
    using BestCS.Math;
        ...
        where TDistribution : IDistribution
    {
        ...
        public new double Run(params Array[] observations)
        {
            ...
            {
                this.samples = (Array)BestCS.Math.Matrix.Concatenate(
                    BestCS.Math.Matrix.Stack(vectorObservations));
            }
            else
            {
                this.samples = (Array)BestCS.Math.Matrix.Stack(vectorObservations);
            }
