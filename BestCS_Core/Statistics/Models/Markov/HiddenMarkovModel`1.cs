...
namespace BestCS.Statistics.Models.Markov
{
    using System;
    using System.IO;
    ...
    using BestCS.Statistics.Models.Markov.Learning;
    using BestCS.Statistics.Models.Markov.Topology;
    ...
    ///   as <see cref="BestCS.Statistics.Distributions.Univariate.NormalDistribution">Gaussian</see>
    ///   <see cref="BestCS.Statistics.Distributions.Univariate.Mixture{T}">Mixture Model</see>) for
    ...
    ///  
    ///  <para>
    ///   If a <see cref="BestCS.Statistics.Distributions.Univariate.GeneralDiscreteDistribution">general
    ...
    ///   <see cref="BestCS.Statistics.Models.Markov.Learning"/> namespace.</para>
    ///   
    /// <para>
    ///   References:
    ///   <list type="bullet">
    ...
    /// <seealso cref="BestCS.Statistics.Models.Markov.Learning"/>
    /// 
    [Serializable]
        ...
        where TDistribution : IDistribution
    {
        ...
        public double[][] Posterior(int[] observations, out int[] path)
        {
            ...
            for (int i = 0; i < path.Length; i++)
                BestCS.Math.Matrix.Max(probabilities[i], out path[i]);
        ...
        public double[] Predict(double[] observations, int next, out double logLikelihood)
        {
            ...
            return BestCS.Math.Matrix.Concatenate(prediction);
        }
