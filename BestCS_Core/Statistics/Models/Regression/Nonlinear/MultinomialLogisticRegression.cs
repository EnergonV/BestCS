...
namespace BestCS.Statistics.Models.Regression
{
    using System;
    using BestCS.Math;
    ...
    public class MultinomialLogisticRegression : ICloneable
    {
        ...
        {
            return ChiSquare(input, BestCS.Statistics.Tools.Expand(classes));
        }
        ...
        {
            return GetLogLikelihood(inputs, BestCS.Statistics.Tools.Expand(classes));
        }
