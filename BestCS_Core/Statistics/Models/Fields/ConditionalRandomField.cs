...
namespace BestCS.Statistics.Models.Fields
{
    using BestCS.Statistics.Models.Fields.Functions;
    using System;
    using System.IO;
    ...
    public class ConditionalRandomField<T> : ICloneable
    {
        ...
        ///   This method is equivalent to the <see cref="BestCS.Statistics.Models.Markov.HiddenMarkovModel.Evaluate(int[], int[])"/>
        ///   method.
        /// </summary>
        /// 
