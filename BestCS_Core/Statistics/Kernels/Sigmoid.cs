...
namespace BestCS.Statistics.Kernels
{
    using System;
    using BestCS.Math;
    using BestCS;
    ...
    public sealed class Sigmoid : KernelBase, IKernel, ICloneable, IEstimable
    {
        ...
        {
            int[] idx = BestCS.Statistics.Tools.RandomSample(inputs.Length, samples);
            int[] idy = BestCS.Statistics.Tools.RandomSample(inputs.Length, samples);
