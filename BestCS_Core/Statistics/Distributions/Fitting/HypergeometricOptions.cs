...
namespace BestCS.Statistics.Distributions.Fitting
{
    ...
    /// <summary>
    ///   Estimable parameters of <see cref="BestCS.Statistics.Distributions.Univariate.
    ...
    /// <summary>
    ///   Estimation options for <see cref="BestCS.Statistics.Distributions.Univariate.
    ...
    public class HypergeometricOptions : IFittingOptions
    {
        ...
        /// <summary>
        ///   Gets or sets which parameter of the <see cref="BestCS.Statistics.Distributions.
