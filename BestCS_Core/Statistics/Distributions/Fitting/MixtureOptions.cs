...
namespace BestCS.Statistics.Distributions.Fitting
{
    ...
    /// <summary>
    ///   Estimation options for <see cref="BestCS.Statistics.Distributions.Univariate.Mixture{T}">univariate</see>
    ///   and <see cref="BestCS.Statistics.Distributions.Multivariate.MultivariateMixture{T}">multivariate</see> 
    ///   <see cref="BestCS.Statistics.Distributions.IMixture{T}">mixture distributions</see>.
    /// </summary>
    /// 
    [Serializable]
