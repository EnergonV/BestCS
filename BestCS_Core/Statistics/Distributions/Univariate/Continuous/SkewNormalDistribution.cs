...
namespace BestCS.Statistics.Distributions.Univariate
{
    ...
    /// </example>
    /// 
    /// <seealso cref="BestCS.Statistics.Distributions.Univariate.NormalDistribution"/>
    ...
    public class SkewNormalDistribution : UnivariateContinuousDistribution
    {
        ...
        public override double DistributionFunction(double x)
        {
            ...
            double cdf = BestCS.Math.Normal.Function(z) - 2 * OwensT.Function(z, alpha);
        ...
        public override double ProbabilityDensityFunction(double x)
        {
            ...
            double a = BestCS.Math.Normal.Derivative(z);
            double b = BestCS.Math.Normal.Function(alpha * z);
        ...
        public override double LogProbabilityDensityFunction(double x)
        {
            ...
            double a = BestCS.Math.Normal.LogDerivative(z);
            double b = Math.Log(BestCS.Math.Normal.Function(alpha * z));
