...
namespace BestCS.Statistics.Distributions.Univariate
{
        ...
        ISampleableDistribution<double>
    {
        ...
        public override void Fit(double[] observations, double[] weights, IFittingOptions options)
        {
            ...
            if (weights == null)
            {
                lambda = 1.0 / BestCS.Statistics.Tools.Mean(observations);
            }
            else
            {
                lambda = 1.0 / BestCS.Statistics.Tools.WeightedMean(observations, weights);
            }
        ...
        public static double[] Random(double lambda, int samples)
        {
            ...
            {
                double u = BestCS.Math.Tools.Random.NextDouble();
