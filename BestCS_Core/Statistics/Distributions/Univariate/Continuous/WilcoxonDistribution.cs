...
namespace BestCS.Statistics.Distributions.Univariate
{
    ...
    ///   positive <see cref="BestCS.Statistics.Tools.Rank">signed ranks 
    ...
    ///   double[] ranks = BestCS.Statistics.Tools.Rank(differences.Abs());
    ///   int[] signs    = BestCS.Math.Matrix.Sign(differences).ToInt32();
    ///   
    ...
    /// </example>
    /// 
    /// <seealso cref="BestCS.Statistics.Testing.WilcoxonSignedRankTest"/>
    /// <seealso cref="BestCS.Statistics.Testing.TwoSampleWilcoxonSignedRankTest"/>
    /// 
    [Serializable]
