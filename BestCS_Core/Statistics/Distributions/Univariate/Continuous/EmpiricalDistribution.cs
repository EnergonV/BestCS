...
namespace BestCS.Statistics.Distributions.Univariate
{
        ...
        ISampleableDistribution<double>
    {
        ...
        {
            double sigma = BestCS.Statistics.Tools.StandardDeviation(observations);
        ...
        public static double SmoothingRule(double[] observations, double[] weights)
        {
            ...
            double sigma = BestCS.Statistics.Tools.WeightedStandardDeviation(observations, weights);
        ...
        public static double SmoothingRule(double[] observations, int[] repeats)
        {
            ...
            double sigma = BestCS.Statistics.Tools.WeightedStandardDeviation(observations, repeats);
            return sigma * Math.Pow(4.0 / (3.0 * N), 1.0 / 5.0);
        }
        ...
        {
            var generator = BestCS.Math.Tools.Random;
