...
namespace BestCS.Statistics.Distributions.Univariate
{
        ...
        IFittableDistribution<double>
    {
        ...
        public override void Fit(double[] observations, double[] weights, IFittingOptions options)
        {
            ...
            if (weights != null)
            {
                mean = BestCS.Statistics.Tools.WeightedMean(observations, weights);
                stdDev = BestCS.Statistics.Tools.WeightedStandardDeviation(observations, weights, mean);
            }
            else
            {
                mean = BestCS.Statistics.Tools.Mean(observations);
                stdDev = BestCS.Statistics.Tools.StandardDeviation(observations, mean);
            }
