...
namespace BestCS.Statistics.Distributions.Univariate
{
    ...
    using BestCS.Math;
    using BestCS.Math.Differentiation;
    using BestCS.Math.Integration;
        ...
        ISampleableDistribution<double>, IFormattable
    {
        ...
        /// </summary>
        /// 
        /// <value>A <see cref="BestCS.DoubleRange"/> containing
...
[RangeAttribute(0, 1)]
        ...
        {
            var random = BestCS.Math.Tools.Random;
        ...
        {
            return InverseDistributionFunction(BestCS.Math.Tools.Random.NextDouble());
        }
