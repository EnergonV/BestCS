...
namespace BestCS.Statistics.Testing
{
    ...
    ///   - this means that it has very general applicability but may lack the <see cref="BestCS.Statistics.Testing.Power">
    ...
    /// <seealso cref="BestCS.Statistics.Distributions.Univariate.BinomialDistribution"/>
    /// 
    [Serializable]
