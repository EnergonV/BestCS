...
namespace BestCS.Statistics.Testing
{
    using System;
    using BestCS.Statistics.Distributions.Univariate;
    using BestCS.Statistics.Testing.Power;
    using BestCS;
    ...
    /// 
    /// <seealso cref="BestCS.Statistics.Distributions.Univariate.TDistribution"/>
    /// 
    [Serializable]
    public class TTest : HypothesisTest<TDistribution>
    {
            ...
            OneSampleHypothesis alternate = OneSampleHypothesis.ValueIsDifferentFromHypothesis)
        {
            ...
            double mean = BestCS.Statistics.Tools.Mean(sample);
            double stdDev = BestCS.Statistics.Tools.StandardDeviation(sample, mean);
            double stdError = BestCS.Statistics.Tools.StandardError(n, stdDev);
        ...
        public TTest(double mean, double stdDev, int samples, double hypothesizedMean = 0,
            OneSampleHypothesis alternate = OneSampleHypothesis.ValueIsDifferentFromHypothesis)
        {
            double stdError = BestCS.Statistics.Tools.StandardError(samples, stdDev);
