...
namespace BestCS
{
    ...
    /// <summary>
    ///   Рантаймное приведение к типу (Runtime cast).
    /// </summary>
    /// 
    /// <typeparam name="T">Целевой тип.</typeparam>
    /// <typeparam name="U">Исходный тип.</typeparam>
    /// 
    internal struct cast<T, U>
    {
        ...
        /// <summary>
        ///   Выводит приводимое значение.
        /// </summary>
        /// 
        public T Value { get { return value; } }

        /// <summary>
        ///   Инициализирует новый экземпляр структуры <see cref="cast{T, U}"/>.
        /// </summary>
        /// 
        public cast(U value)
        {
        ...
        /// <summary>
        /// Выполняет неявное преобразование из <typeparamref name="U"/> в <see cref="cast{T, U}"/>.
        /// </summary>
        ...
        /// <summary>
        /// Выполняет неявное преобразование из <see cref="cast{T, U}"/> в <typeparamref name="T"/>.
        /// </summary>
        /// <param name="value">Значение.</param>
        /// <returns>
        /// Результат преобразования.
