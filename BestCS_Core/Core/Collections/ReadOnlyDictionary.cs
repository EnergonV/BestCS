...
namespace BestCS.Collections
{
    ...
    public class ReadOnlyDictionary<TKey, TValue> : IDictionary<TKey, TValue>
    {
        ...
        {
            throw new NotSupportedException("Этот словарь только для чтения");
        }
        ...
        public TValue this[TKey key]
        {
            ...
            set { throw new NotSupportedException("Этот словарь только для чтения"); }
        }
